...
startbbr(){
	...
	wget --no-check-certificate -O ./tcp_tsunami.c https://raw.githubusercontent.com/LisonTsang/BBR-Mod-backup/master/tcp_tsunami.c
	...
	wget -O /etc/sysctl.conf -N --no-check-certificate https://raw.githubusercontent.com/LisonTsang/YankeeBBR/master/sysctl.conf
	sysctl -p
